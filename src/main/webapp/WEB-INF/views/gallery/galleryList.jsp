				...
				$(document).on("click", ".pwdCheckBtn", function(){
					...
					if(!formCheck(passwd, message, "비밀번호를")) return;
						...
						/* 호출 함수.then() 함수 매개변수로 성공 콜백함수, 실패 콜백함수 넘겨줌 -
						   각 함수의 매개변수는 resolve, reject 함수에서 넘겨준 매개변수를 자동으로 넘겨받는다. */
						...
						$('#f_writeForm').ajaxForm({
							...
							success : function(data){
								...
								if(data=="성공"){
									...
									alert("[" + data + "]/n수정에 문제가 있어 완료하지 못하였습니다.잠시후 다시 시도해 주세요");
									dataReset();
		...
		<div class="contentContainer container">
						...
						<div class="modal-body">
							<form id="f_writeForm" name="f_writeForm">
								...
								<div class="form-group">
							    	...
							    	<input type="text" class="form-control" name="g_subject" id="g_subject" maxlength="12" />
							    </div>
							    <div class="form-group">
							    ...
							    <div class="form-group">
									...
									<input type="text" class="form-control" name="g_pwd" id="g_pwd" />
							    </div>
							</form>
						</div>
			...
			<div id="popover-content" class="hide">
				<form name="f_passwd" class="form-inline">
					...
					<div class="form-group">
						<label class="message">비밀번호를 입력해주세요.</label>
					</div>
					<div class="form-group">
